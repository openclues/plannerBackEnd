...
from customuser.views import UserApiView
from onboarding.views import GetOnBoarindListApiView
...
urlpatterns = [
    ...
    path('data/user/', UserApiView.as_view()),

    path('onboarding/', GetOnBoarindListApiView.as_view()),
]